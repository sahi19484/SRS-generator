...
`;
  ...
  const getProgressPercentage = () => {
    ...
    const completedFields = Object.values(srsData).filter(
      (v) => v.trim().length > 0,
    ).length;
  ...
  return (
    <div className="min-h-screen transition-colors duration-300 bg-white dark:bg-slate-950">
      {/* Header */}
      <div
        className={`sticky top-0 z-40 border-b transition-colors duration-300 ${isDarkMode ? "border-slate-800 bg-slate-900" : "border-slate-200 bg-white"}`}
      >
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
          ...
          <div className="rounded-lg p-6 h-fit transition-colors duration-300 bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 shadow-sm">
            <h2 className="text-lg font-heading font-bold mb-4 text-slate-900 dark:text-white">
              Steps
            </h2>
              ...
              <CardContent className="p-6 space-y-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        <Label
                          htmlFor="title"
                          className="text-slate-700 dark:text-slate-300 font-sans"
                        >
                          Document Title
                        </Label>
                        <Input
                ...
                {activeSection === "requirements" && (
                  <div className="space-y-4">
                    ...
                    <div className="space-y-4">
                      <div>
                        <Label
                          htmlFor="functionalRequirements"
                          className="text-slate-700 dark:text-slate-300 font-sans"
                        >
                      ...
                      <div>
                        <Label
                          htmlFor="performanceRequirements"
                          className="text-slate-700 dark:text-slate-300 font-sans"
                        >
                ...
                {activeSection === "nonfunctional" && (
                  <div className="space-y-4">
                    ...
                    <div>
                      <Label
                        htmlFor="nonFunctionalAttributes"
                        className="text-slate-700 dark:text-slate-300 font-sans"
                      >
                        Non-Functional Attributes
                      </Label>
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          handleInputChange("scheduleAndBudget", e.target.value)
                        }
                  ...
                  <div className="space-y-4">
                    ...
                    <div>
                      ...
                      <Textarea
                        ...
                        onChange={(e) =>
                          handleInputChange("appendices", e.target.value)
                        }
                ...
                <ScrollArea className="h-96 rounded-md bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 p-3">
                  <div className="text-xs font-mono space-y-2 text-slate-700 dark:text-slate-300">
                    <div>
                      ...
                      {srsData.title || "(Not filled)"}
                    </div>
                    <div>
                      <span className="font-bold">Authors:</span>{" "}
                      {srsData.authors || "(Not filled)"}
                    </div>
                    <div>
                      <span className="font-bold">Affiliation:</span>{" "}
                      {srsData.affiliation || "(Not filled)"}
                    </div>
                    <div>
                      <span className="font-bold">Date:</span> {srsData.date}
                    </div>
                    <div>
                    ...
                    {srsData.purpose && (
                      <div className="mt-3">
                        ...
                        {srsData.purpose.substring(0, 100)}...
                      </div>
                    )}
                    {srsData.scope && (
                      <div>
                        <span className="font-bold">Scope:</span>{" "}
                        {srsData.scope.substring(0, 100)}...
                      </div>
                    )}
                    {srsData.functionalRequirements && (
                      <div>
                        <span className="font-bold">Functional Req:</span>{" "}
        ...
        <Dialog open={previewOpen} onOpenChange={setPreviewOpen}>
          <DialogContent className="max-w-2xl max-h-[80vh] bg-white dark:bg-slate-900 dark:border dark:border-slate-800">
            <DialogHeader>
              <DialogTitle className="font-heading text-slate-900 dark:text-white">
                Document Preview
              </DialogTitle>
